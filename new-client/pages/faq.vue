      ...
      qas: [
        {
          ...
          a: `
            ...
            <ul>
              ...
              <li>Users can ‘flag as inappropriate’ if a review is violating the Terms of Use, so that abusive content and harassment does not get spread.</li>
              <li>Reviewers are assigned a 'reliability score' by the aggregation algorithm, reflecting their track record in providing useful reviews.</li>
              <li>Businesses can interact with their customers and reply to reviews, thereby allowing a more balanced view, especially when conflicts occurred.</li>
              <li>Businesses can invite their customers to leave reviews in the Mangrove database, allowing to mark those reviews as 'verified purchases'.</li>
        ...
        },
        {
          ...
          a: `
            <ul>
              <li>No registration or login process requiring personal data.</li>
              <li>No tracking, no cookies, no gathering of user data behind the scenes, and no advertisement.</li>
              <li>We use public key cryptography to create an identity for users within Mangrove so that we can establish reputation within the system.</li>
              <li>A reviewer can change their identity in Mangrove by creating as many public keys as they wish. They are all linked to one root secret key (private key) which only the reviewer holds, so neither Mangrove nor anyone else can connect the public keys to the same person.</li>
              <li>The cryptographic key pair is generated by the user’s browser, and it is stored locally on the device within the browser’s IndexedDB (we do not require any cookies for this) for as long as the storage is not cleared.</li>
            </ul>
          `
        },
        {
