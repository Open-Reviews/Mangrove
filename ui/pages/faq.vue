        ...
        },
        {
          ...
          a: `
            <ul>
              ...
              <li>A reviewer can have several identities in Mangrove by creating as many public keys as they wish. They are all linked to one root secret key (=secret key) which only the reviewer holds. Neither Mangrove nor anyone else can connect the public keys to the same person.</li>
              <li>The cryptographic key pair is generated by the user’s browser, and it is <b>stored locally on the device</b> within the browser’s IndexedDB (we strongly recommend copying and storing your secret key in a cross-device password manager).</li>
            </ul>
          `
        },
        {
          ...
          a: `
            When you write a review within Mangrove, your browser generates a cryptographic key pair, consisting of a public key and a secret key, and it saves both in its storage (IndexedDB) on your device.
            <ul>
              <li><b>Public key</b>: Your review will be stored in the Mangrove open dataset together with the public key. So it serves as an identifier for you, and removes the need for a registration or login process. This identifier allows us to assign a reputation to you: the more reviews you write using the same public key, and the more upvotes you get, the more weight your reviews receive. You can always generate new public keys, e.g., if you want to review something that you do not wish to link to your other reviews. All your public keys are connected to the same secret key and can be accessed through it. Each time you write a review you can choose the public key you’d like to use, or generate a new one.</li>
              <li><b>Secret key</b>: It serves as a secret password that allows you to access your public keys. Only if you hold the secret key, you can access your public keys from any device, and re-import it in case your browser’s storage gets cleared for some reason.</li>
            </ul>
            Please note that the key pairs are generated and stored locally on your device. This means that Mangrove is not able to see or to store your secret key. In case you lose the secret key, Mangrove does not have any possibility to recover it. <b>We recommend to save the secret key in a password manager</b> (e.g., open source and privacy-preserving Bitwarden) that you have on multiple devices. So you can easily import the secret key if you use different devices to write reviews.
          `
        },
        {
