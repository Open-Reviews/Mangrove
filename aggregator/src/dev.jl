...
Ratings = Array{Pair{Tuple{String, String}, Float64}}
function do_inference(
  ...
  subjects = Set(r[1][1] for r in ratings)
  reviewers = Set(r[1][2] for r in ratings)
...
trace = do_inference(mangrove_model, data, 10000)
